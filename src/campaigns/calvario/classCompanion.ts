...
const MIR_SHADOWS_LORE_PT = `O que ela chama de "roubar ao escuro" não é pilhagem: é tirar à noite o direito de mentir sobre o medo. Quem ouviu isso à luz do seu fogo fica com o nome dela um pouco mais pesado — e com a certeza de que ela já sabia seu segredo antes de você o dizer.`;

const MIR_CRUZEIRO_LORE_PT = `No cruzeiro de pedra, trocou com você verdades fracas como quem troca facas embrulhadas em pano: ninguém vê o fio até ser tarde. Desde aí, o mapa que ela desenha na cabeça inclui um cantseu que não aparece em nenhum corredor — só em silêncio acordado.`;
