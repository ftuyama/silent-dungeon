...
---
Cada osso do trono tem **um nome** raspado — você não consegue ler todos. Um deles é seu **primeiro medo** em letras pequenas. As correntes pingam memória densa demais.
