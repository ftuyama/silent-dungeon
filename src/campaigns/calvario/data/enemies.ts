...
export const enemies: Record<string, EnemyDef> = {
  ...
  edras_contrawind_duelist: {
    id: 'edras_contrawind_duelist',
    ...
    armorChips: 2,
    xp: 80,
    sprite: E.act5_edras_contrawind.sprite,
    attackStrategy: 'focus_leader',
    abilities: [
      {
        id: 'contrawind_bulwark',
        name: 'Baluarte do Contravento',
        kind: 'self_buff',
        dice: 0,
        base: 1,
        linePt: 'O círculo aperta ao redor de Edras; o gelo recusa o primeiro golpe.',
      },
      {
        id: 'ice_lance',
        name: 'Lança de Gelo',
        ...
        dice: 3,
        base: 1,
        applyStatus: { kind: 'freeze', chance: 0.4, rounds: 1, intensity: 0 },
        linePt: 'Edras aponta dois dedos; uma agulha de inverno escolhe a sua respiração.',
      },
      {
        id: 'wind_scourge',
        name: 'Açoite de Vento',
        kind: 'area_strike',
        dice: 2,
        base: 1,
        linePt: 'O contravento dobra a capela inteira e passa por todos como lâmina.',
      },
      {
        id: 'circle_pressure',
        name: 'Pressão do Círculo',
        kind: 'stress_wave',
        dice: 0,
        base: 0,
        linePt: 'A neve sobe contra o céu; por um segundo, até o medo parece ter peso.',
      },
    ],
    behavior: {
      opening: 'contrawind_bulwark',
      rotation: ['ice_lance', 'wind_scourge', 'circle_pressure'],
      desperation: { hpFractionLte: 0.35, rotation: ['ice_lance', 'wind_scourge', 'ice_lance'] },
    },
    combatLines: [
      'Não é lição. É limite.',
      'O vento corta quem tenta possuí-lo.',
      'Levante-se ou pare de chamar fome de direito.',
    ],
  },
  frost_whelp: {
    id: 'frost_whelp',
